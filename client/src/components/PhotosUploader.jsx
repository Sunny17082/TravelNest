					...
					addedPhotos.map((link) => (
						<div className="h-32 flex relative" key={link}>
							...
							<button
								...
								className="absolute bottom-2 right-2 text-white bg-black bg-opacity-50 rounded-md p-2 cursor-pointer"
							>
								<svg
							...
							<button
								...
								className="absolute bottom-2 left-2 text-white bg-black bg-opacity-50 rounded-md p-2 cursor-pointer"
							>
								{link === addedPhotos[0] && (
									<svg
										xmlns="http://www.w3.org/2000/svg"
